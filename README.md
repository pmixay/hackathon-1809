...
R2 выбрал P2z по минимальной стоимости прохождения обязательного стресса после заблаговременной адаптации;
это не доказательство универсальной устойчивости (см. `docs/management_note.md`).
