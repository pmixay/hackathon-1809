...
const slides=[
 ...
 {title:'Риски и правила реакции',lines:['Буфер запаса нужен до начала года: поздняя реакция не исправит резерв на 1 января.','Дозаказ Flex требует 4 месяцев, Emergency — 6 недель.','Оператор отвечает за резерв, финансирующая сторона — за инвестиционные ворота.','Обратный стресс и Монте-Карло пока не реализованы. Итоговый выбор стратегии остаётся за R2/R3.'],source:'results/reaction/summary.md; docs/risk_register.md; docs/stakeholders.md; docs/TEAM.md'},
