...
величина всего портфеля — 8 729,404 млн PV при реальной ставке 8 %). Все значения взяты из того же
...
| Оператор узла | 1 390,000 выдано, 29,492 потеряно при хранении | 10 980,255 полных затрат, в том числе 135,655 за хранение | 578,846 по всем каналам | 0,000 | платит всё перечисленное и отвечает за остаток риска |
