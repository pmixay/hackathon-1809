...
**Дополнение R3: цена конкретной защиты (EXP-12).** На этапе DP-1 можно заранее согласовать
...
не проходит; источник: `results/p2z_resilience/comparison.csv`, `yearly.csv`.
...
сторона с остаточным риском указаны в `docs/contract_strategy.md` как `TEAM_ASSUMPTION`; их цена не включена в EXP-01/02/09.
