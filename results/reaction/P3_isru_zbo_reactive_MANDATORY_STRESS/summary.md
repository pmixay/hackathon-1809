...
| EMERGENCY_BASE_STREAK | 2038 | emergency_share_of_demand | 0.1363 | 0.2000 | <= (иначе год считается базовым для Emergency) | выполнено | жёсткое |
...
| EMERGENCY_BASE_STREAK | 2040 | emergency_share_of_demand | 0.0757 | 0.2000 | <= (иначе год считается базовым для Emergency) | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2038 | max_end_of_month_stock_t | 45.3790 | 120.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2039 | max_end_of_month_stock_t | 55.3037 | 120.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2040 | max_end_of_month_stock_t | 55.3035 | 120.0000 | <= | выполнено | жёсткое |
