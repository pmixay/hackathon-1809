...
|---|---|---:|
| Полные затраты, млн | `total_cost_mln` | 9,879.472 |
| Приведённые затраты (PV), млн | `pv_cost_mln` | 7,857.380 |
| Затраты на обслуженную тонну, млн/т | `cost_per_served_t_mln` | 7.644 |
| PV затрат на обслуженную тонну, млн/т | `pv_cost_per_served_t_mln` | 6.079 |
...
| Хранение, млн | `holding_total_mln` | 86.651 |
...
| STORAGE_OVERFLOW | 2037 | max_end_of_month_stock_t | 30.8223 | 70.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2038 | max_end_of_month_stock_t | 39.4524 | 70.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2039 | max_end_of_month_stock_t | 36.6607 | 70.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2040 | max_end_of_month_stock_t | 0.0000 | 70.0000 | <= | выполнено | жёсткое |
