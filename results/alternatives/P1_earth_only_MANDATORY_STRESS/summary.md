...
| STORAGE_OVERFLOW | 2038 | max_end_of_month_stock_t | 28.4164 | 70.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2039 | max_end_of_month_stock_t | 0.0000 | 70.0000 | <= | выполнено | жёсткое |
