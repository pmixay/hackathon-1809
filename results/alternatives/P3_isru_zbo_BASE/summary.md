...
|---|---|---:|
| Полные затраты, млн | `total_cost_mln` | 10,654.259 |
| Приведённые затраты (PV), млн | `pv_cost_mln` | 8,638.857 |
| Затраты на обслуженную тонну, млн/т | `cost_per_served_t_mln` | 7.665 |
| PV затрат на обслуженную тонну, млн/т | `pv_cost_per_served_t_mln` | 6.215 |
...
| Хранение, млн | `holding_total_mln` | 129.727 |
...
| STORAGE_OVERFLOW | 2040 | max_end_of_month_stock_t | 48.0826 | 120.0000 | <= | выполнено | жёсткое |
