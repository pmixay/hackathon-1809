...
| STORAGE_OVERFLOW | 2039 | max_end_of_month_stock_t | 48.0826 | 70.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2040 | max_end_of_month_stock_t | 48.0826 | 70.0000 | <= | выполнено | жёсткое |
