...
План исполним: **ДА** — жёстких нарушений: 0, отклонений от ориентиров: 0, предупреждений: 19
...
|---|---|---:|
| Полные затраты, млн | `total_cost_mln` | 11,079.235 |
| Приведённые затраты (PV), млн | `pv_cost_mln` | 8,779.822 |
| Затраты на обслуженную тонну, млн/т | `cost_per_served_t_mln` | 7.971 |
| PV затрат на обслуженную тонну, млн/т | `pv_cost_per_served_t_mln` | 6.316 |
...
| Хранение, млн | `holding_total_mln` | 136.259 |
...
|---|---|---:|---:|---|---:|---:|---:|---|
| INTRA_MONTH_PEAK | предупреждение | 2039 | 6 |  | 70.434 | 70.000 | 0.434 | запас после поступления 70.434 т превышает ёмкость хранилища Base storage 70.0 т внутри 2039-06 (до выдачи потребителям) |
| INTRA_MONTH_PEAK | предупреждение | 2039 | 7 |  | 71.153 | 70.000 | 1.153 | запас после поступления 71.153 т превышает ёмкость хранилища Base storage 70.0 т внутри 2039-07 (до выдачи потребителям) |
| INTRA_MONTH_PEAK | предупреждение | 2039 | 8 |  | 71.873 | 70.000 | 1.873 | запас после поступления 71.873 т превышает ёмкость хранилища Base storage 70.0 т внутри 2039-08 (до выдачи потребителям) |
| INTRA_MONTH_PEAK | предупреждение | 2039 | 9 |  | 72.592 | 70.000 | 2.592 | запас после поступления 72.592 т превышает ёмкость хранилища Base storage 70.0 т внутри 2039-09 (до выдачи потребителям) |
| INTRA_MONTH_PEAK | предупреждение | 2039 | 10 |  | 73.311 | 70.000 | 3.311 | запас после поступления 73.311 т превышает ёмкость хранилища Base storage 70.0 т внутри 2039-10 (до выдачи потребителям) |
| INTRA_MONTH_PEAK | предупреждение | 2039 | 11 |  | 74.030 | 70.000 | 4.030 | запас после поступления 74.030 т превышает ёмкость хранилища Base storage 70.0 т внутри 2039-11 (до выдачи потребителям) |
| INTRA_MONTH_PEAK | предупреждение | 2039 | 12 |  | 74.749 | 70.000 | 4.749 | запас после поступления 74.749 т превышает ёмкость хранилища Base storage 70.0 т внутри 2039-12 (до выдачи потребителям) |
| INTRA_MONTH_PEAK | предупреждение | 2040 | 1 |  | 80.583 | 70.000 | 10.583 | запас после поступления 80.583 т превышает ёмкость хранилища Base storage 70.0 т внутри 2040-01 (до выдачи потребителям) |
| INTRA_MONTH_PEAK | предупреждение | 2040 | 2 |  | 80.583 | 70.000 | 10.583 | запас после поступления 80.583 т превышает ёмкость хранилища Base storage 70.0 т внутри 2040-02 (до выдачи потребителям) |
| INTRA_MONTH_PEAK | предупреждение | 2040 | 3 |  | 80.583 | 70.000 | 10.583 | запас после поступления 80.583 т превышает ёмкость хранилища Base storage 70.0 т внутри 2040-03 (до выдачи потребителям) |
| INTRA_MONTH_PEAK | предупреждение | 2040 | 4 |  | 80.583 | 70.000 | 10.583 | запас после поступления 80.583 т превышает ёмкость хранилища Base storage 70.0 т внутри 2040-04 (до выдачи потребителям) |
| INTRA_MONTH_PEAK | предупреждение | 2040 | 5 |  | 80.583 | 70.000 | 10.583 | запас после поступления 80.583 т превышает ёмкость хранилища Base storage 70.0 т внутри 2040-05 (до выдачи потребителям) |
| INTRA_MONTH_PEAK | предупреждение | 2040 | 6 |  | 80.583 | 70.000 | 10.583 | запас после поступления 80.583 т превышает ёмкость хранилища Base storage 70.0 т внутри 2040-06 (до выдачи потребителям) |
| INTRA_MONTH_PEAK | предупреждение | 2040 | 7 |  | 80.583 | 70.000 | 10.583 | запас после поступления 80.583 т превышает ёмкость хранилища Base storage 70.0 т внутри 2040-07 (до выдачи потребителям) |
| INTRA_MONTH_PEAK | предупреждение | 2040 | 8 |  | 80.583 | 70.000 | 10.583 | запас после поступления 80.583 т превышает ёмкость хранилища Base storage 70.0 т внутри 2040-08 (до выдачи потребителям) |
| INTRA_MONTH_PEAK | предупреждение | 2040 | 9 |  | 80.583 | 70.000 | 10.583 | запас после поступления 80.583 т превышает ёмкость хранилища Base storage 70.0 т внутри 2040-09 (до выдачи потребителям) |
| INTRA_MONTH_PEAK | предупреждение | 2040 | 10 |  | 80.583 | 70.000 | 10.583 | запас после поступления 80.583 т превышает ёмкость хранилища Base storage 70.0 т внутри 2040-10 (до выдачи потребителям) |
| INTRA_MONTH_PEAK | предупреждение | 2040 | 11 |  | 80.583 | 70.000 | 10.583 | запас после поступления 80.583 т превышает ёмкость хранилища Base storage 70.0 т внутри 2040-11 (до выдачи потребителям) |
| INTRA_MONTH_PEAK | предупреждение | 2040 | 12 |  | 80.583 | 70.000 | 10.583 | запас после поступления 80.583 т превышает ёмкость хранилища Base storage 70.0 т внутри 2040-12 (до выдачи потребителям) |
