...
| BASE_CRITICAL_SERVICE | 2041 | critical_service_level | 1.0000 | 0.9900 | >= | OK | guideline |
...
| BASE_TOTAL_SERVICE | 2041 | total_service_level | 1.0000 | 0.9700 | >= | OK | guideline |
...
| RESERVE_45D | 2041 | opening_stock_vs_45d_reserve_t | 55.4798 | 55.4795 | >= | OK | hard |
...
| EMERGENCY_BASE_STREAK | 2041 | emergency_share_of_demand | 0.0000 | 0.2000 | <= (else counts as base year) | OK | hard |
...
| CAPACITY_EXCEEDED | 2039 | reserved_A_t_per_year | 152.6220 | 190.0000 | <= | OK | hard |
| ORDER_EXCEEDS_RESERVATION | 2039 | ordered_A_t | 152.6216 | 152.6220 | <= | OK | hard |
...
| CAPACITY_EXCEEDED | 2039 | reserved_X_t_per_year | 60.0000 | 60.0000 | <= | OK | hard |
| ORDER_EXCEEDS_RESERVATION | 2039 | ordered_X_t | 60.0000 | 60.0000 | <= | OK | hard |
...
| STORAGE_OVERFLOW | 2040 | max_end_of_month_stock_t | 55.4798 | 120.0000 | <= | OK | hard |
...
| CAPACITY_EXCEEDED | 2040 | reserved_B_t_per_year | 32.2240 | 110.0000 | <= | OK | hard |
| ORDER_EXCEEDS_RESERVATION | 2040 | ordered_B_t | 32.2240 | 32.2240 | <= | OK | hard |
...
| CAPACITY_EXCEEDED | 2040 | reserved_X_t_per_year | 60.0000 | 60.0000 | <= | OK | hard |
| ORDER_EXCEEDS_RESERVATION | 2040 | ordered_X_t | 60.0000 | 60.0000 | <= | OK | hard |
...
| STORAGE_OVERFLOW | 2041 | max_end_of_month_stock_t | 55.4799 | 120.0000 | <= | OK | hard |
| CAPACITY_EXCEEDED | 2041 | reserved_A_t_per_year | 190.0000 | 190.0000 | <= | OK | hard |
| ORDER_EXCEEDS_RESERVATION | 2041 | ordered_A_t | 190.0000 | 190.0000 | <= | OK | hard |
| CAPACITY_EXCEEDED | 2041 | reserved_B_t_per_year | 85.4660 | 110.0000 | <= | OK | hard |
| ORDER_EXCEEDS_RESERVATION | 2041 | ordered_B_t | 85.4656 | 85.4660 | <= | OK | hard |
| CAPACITY_EXCEEDED | 2041 | reserved_D_t_per_year | 120.0000 | 120.0000 | <= | OK | hard |
| ORDER_EXCEEDS_RESERVATION | 2041 | ordered_D_t | 120.0000 | 120.0000 | <= | OK | hard |
| CAPACITY_EXCEEDED | 2041 | reserved_X_t_per_year | 60.0000 | 60.0000 | <= | OK | hard |
| ORDER_EXCEEDS_RESERVATION | 2041 | ordered_X_t | 60.0000 | 60.0000 | <= | OK | hard |
| LEAD_TIME_VIOLATED | 2041 | all_deliveries_ordered_within_lead_time | 1.0000 | 1.0000 | == | OK | hard |
| SOURCE_NOT_AVAILABLE | 2041 | all_orders_from_available_sources | 1.0000 | 1.0000 | == | OK | hard |
