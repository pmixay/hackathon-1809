...
|---|---|---:|
| Полные затраты, млн | `total_cost_mln` | 13,273.298 |
| Приведённые затраты (PV), млн | `pv_cost_mln` | 10,271.043 |
| Затраты на обслуженную тонну, млн/т | `cost_per_served_t_mln` | 7.214 |
| PV затрат на обслуженную тонну, млн/т | `pv_cost_per_served_t_mln` | 5.582 |
| Обслужено, т | `served_total_t` | 1,840.000 |
| Спрос, т | `demand_total_t` | 1,840.000 |
...
| Потери при хранении, т | `losses_total_t` | 35.048 |
| CAPEX, млн | `capex_total_mln` | 1,430.000 |
| Закупка, млн | `procurement_total_mln` | 10,763.099 |
| Резервирование мощности, млн | `reservation_total_mln` | 573.863 |
| Хранение, млн | `holding_total_mln` | 172.336 |
| Постоянный OPEX, млн | `fixed_opex_total_mln` | 334.000 |
...
| 2040 | 390.0 | 250.0 | 390.0 | 1.000 | 1.000 | 0.0 | 402.2 | 4.83 | 48.1 | 55.5 | 48.1 | выполнен | ZBO |
| 2041 | 450.0 | 290.0 | 450.0 | 1.000 | 1.000 | 0.0 | 455.5 | 5.47 | 55.5 | 55.5 | 55.5 | выполнен | ZBO |
...
| BASE_CRITICAL_SERVICE | 2041 | critical_service_level | 1.0000 | 0.9900 | >= | выполнено | ориентир |
...
| BASE_TOTAL_SERVICE | 2041 | total_service_level | 1.0000 | 0.9700 | >= | выполнено | ориентир |
...
| RESERVE_45D | 2041 | opening_stock_vs_45d_reserve_t | 55.4798 | 55.4795 | >= | выполнено | жёсткое |
...
| EMERGENCY_BASE_STREAK | 2041 | emergency_share_of_demand | 0.0000 | 0.2000 | <= (иначе год считается базовым для Emergency) | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2038 | max_end_of_month_stock_t | 39.4524 | 120.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2039 | max_end_of_month_stock_t | 48.0825 | 120.0000 | <= | выполнено | жёсткое |
| CAPACITY_EXCEEDED | 2039 | reserved_A_t_per_year | 152.6220 | 190.0000 | <= | выполнено | жёсткое |
| ORDER_EXCEEDS_RESERVATION | 2039 | ordered_A_t | 152.6216 | 152.6220 | <= | выполнено | жёсткое |
...
| CAPACITY_EXCEEDED | 2039 | reserved_X_t_per_year | 60.0000 | 60.0000 | <= | выполнено | жёсткое |
| ORDER_EXCEEDS_RESERVATION | 2039 | ordered_X_t | 60.0000 | 60.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2040 | max_end_of_month_stock_t | 55.4798 | 120.0000 | <= | выполнено | жёсткое |
...
| CAPACITY_EXCEEDED | 2040 | reserved_B_t_per_year | 32.2240 | 110.0000 | <= | выполнено | жёсткое |
| ORDER_EXCEEDS_RESERVATION | 2040 | ordered_B_t | 32.2240 | 32.2240 | <= | выполнено | жёсткое |
...
| CAPACITY_EXCEEDED | 2040 | reserved_X_t_per_year | 60.0000 | 60.0000 | <= | выполнено | жёсткое |
| ORDER_EXCEEDS_RESERVATION | 2040 | ordered_X_t | 60.0000 | 60.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2041 | max_end_of_month_stock_t | 55.4799 | 120.0000 | <= | выполнено | жёсткое |
| CAPACITY_EXCEEDED | 2041 | reserved_A_t_per_year | 190.0000 | 190.0000 | <= | выполнено | жёсткое |
| ORDER_EXCEEDS_RESERVATION | 2041 | ordered_A_t | 190.0000 | 190.0000 | <= | выполнено | жёсткое |
| CAPACITY_EXCEEDED | 2041 | reserved_B_t_per_year | 85.4660 | 110.0000 | <= | выполнено | жёсткое |
| ORDER_EXCEEDS_RESERVATION | 2041 | ordered_B_t | 85.4656 | 85.4660 | <= | выполнено | жёсткое |
| CAPACITY_EXCEEDED | 2041 | reserved_D_t_per_year | 120.0000 | 120.0000 | <= | выполнено | жёсткое |
| ORDER_EXCEEDS_RESERVATION | 2041 | ordered_D_t | 120.0000 | 120.0000 | <= | выполнено | жёсткое |
| CAPACITY_EXCEEDED | 2041 | reserved_X_t_per_year | 60.0000 | 60.0000 | <= | выполнено | жёсткое |
| ORDER_EXCEEDS_RESERVATION | 2041 | ordered_X_t | 60.0000 | 60.0000 | <= | выполнено | жёсткое |
| LEAD_TIME_VIOLATED | 2041 | all_deliveries_ordered_within_lead_time | 1.0000 | 1.0000 | == | выполнено | жёсткое |
| SOURCE_NOT_AVAILABLE | 2041 | all_orders_from_available_sources | 1.0000 | 1.0000 | == | выполнено | жёсткое |
