...
|---|---|---:|
| Полные затраты, млн | `total_cost_mln` | 10,993.260 |
| Приведённые затраты (PV), млн | `pv_cost_mln` | 8,740.606 |
| Затраты на обслуженную тонну, млн/т | `cost_per_served_t_mln` | 7.909 |
| PV затрат на обслуженную тонну, млн/т | `pv_cost_per_served_t_mln` | 6.288 |
...
| Потери при хранении, т | `losses_total_t` | 31.225 |
| CAPEX, млн | `capex_total_mln` | 540.000 |
| Закупка, млн | `procurement_total_mln` | 9,699.181 |
| Резервирование мощности, млн | `reservation_total_mln` | 579.106 |
| Хранение, млн | `holding_total_mln` | 135.973 |
...
| 2037 | 190.0 | 135.0 | 190.0 | 1.000 | 1.000 | 0.0 | 204.9 | 7.52 | 23.4 | 30.8 | 23.4 | выполнен | ZBO |
...
| 2037 | 1287.1 | 0.0 | 89.7 | 18.9 | 3.0 | 180.0 | 1578.7 | 1353.4 |
...
| 2037 | Earth-Flex | 1.7 | 1.7 | 1.7 | 8.90 | 1.7 | 15.4 | 0.0 | 0.3 |
...
| RESERVE_45D | 2038 | opening_stock_vs_45d_reserve_t | 30.8228 | 30.8219 | >= | выполнено | жёсткое |
| RESERVE_45D | 2039 | opening_stock_vs_45d_reserve_t | 39.4529 | 39.4521 | >= | выполнено | жёсткое |
| RESERVE_45D | 2040 | opening_stock_vs_45d_reserve_t | 48.0831 | 48.0822 | >= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2037 | end_of_month_stock_t_in_worst_month | 27.4931 | 70.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2037 | intra_month_peak_stock_t_in_worst_month | 43.3264 | 70.0000 | <= | выполнено | жёсткое |
...
| CAPACITY_EXCEEDED | 2037 | reserved_B_t_per_year | 1.7334 | 110.0000 | <= | выполнено | жёсткое |
| ORDER_EXCEEDS_RESERVATION | 2037 | ordered_B_t | 1.7334 | 1.7334 | <= | выполнено | жёсткое |
...
| INTRA_MONTH_PEAK | 2038 | intra_month_peak_stock_t_in_worst_month | 60.2863 | 120.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2039 | end_of_month_stock_t_in_worst_month | 48.0831 | 120.0000 | <= | выполнено | жёсткое |
