...
|---|---|---:|
| Полные затраты, млн | `total_cost_mln` | 12,825.011 |
| Приведённые затраты (PV), млн | `pv_cost_mln` | 10,108.983 |
| Затраты на обслуженную тонну, млн/т | `cost_per_served_t_mln` | 8.361 |
| PV затрат на обслуженную тонну, млн/т | `pv_cost_per_served_t_mln` | 6.590 |
...
| Потери при хранении, т | `losses_total_t` | 32.894 |
| CAPEX, млн | `capex_total_mln` | 540.000 |
| Закупка, млн | `procurement_total_mln` | 11,498.100 |
| Резервирование мощности, млн | `reservation_total_mln` | 605.093 |
| Хранение, млн | `holding_total_mln` | 142.818 |
...
| 2037 | 190.0 | 135.0 | 190.0 | 1.000 | 1.000 | 0.0 | 209.7 | 7.70 | 23.4 | 35.4 | 23.4 | выполнен | ZBO |
...
| 2037 | 1321.2 | 0.0 | 91.2 | 20.5 | 3.0 | 180.0 | 1615.9 | 1385.4 |
...
| 2037 | Earth-Flex | 1.8 | 1.8 | 1.8 | 8.90 | 1.8 | 15.8 | 0.0 | 0.3 |
...
| STORAGE_OVERFLOW | 2037 | end_of_month_stock_t_in_worst_month | 30.9255 | 70.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2037 | intra_month_peak_stock_t_in_worst_month | 46.7589 | 70.0000 | <= | выполнено | жёсткое |
...
| CAPACITY_EXCEEDED | 2037 | reserved_B_t_per_year | 1.7734 | 110.0000 | <= | выполнено | жёсткое |
| ORDER_EXCEEDS_RESERVATION | 2037 | ordered_B_t | 1.7734 | 1.7734 | <= | выполнено | жёсткое |
