...
|---|---|---:|
| Полные затраты, млн | `total_cost_mln` | 12,838.736 |
| Приведённые затраты (PV), млн | `pv_cost_mln` | 10,120.750 |
| Затраты на обслуженную тонну, млн/т | `cost_per_served_t_mln` | 8.369 |
| PV затрат на обслуженную тонну, млн/т | `pv_cost_per_served_t_mln` | 6.598 |
...
| Потери при хранении, т | `losses_total_t` | 34.714 |
| CAPEX, млн | `capex_total_mln` | 540.000 |
| Закупка, млн | `procurement_total_mln` | 11,514.292 |
| Резервирование мощности, млн | `reservation_total_mln` | 605.366 |
| Хранение, млн | `holding_total_mln` | 143.078 |
...
| 2037 | 190.0 | 135.0 | 190.0 | 1.000 | 1.000 | 0.0 | 211.5 | 9.52 | 23.4 | 35.4 | 23.4 | выполнен | BASE |
...
| 2037 | 1337.4 | 0.0 | 91.4 | 20.8 | 0.0 | 180.0 | 1629.6 | 1397.1 |
...
| 2037 | Earth-Flex | 3.6 | 3.6 | 3.6 | 8.90 | 3.6 | 32.0 | 0.0 | 0.5 |
...
| RESERVE_45D | 2039 | opening_stock_vs_45d_reserve_t | 45.3702 | 45.3699 | >= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2037 | end_of_month_stock_t_in_worst_month | 35.4455 | 70.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2037 | intra_month_peak_stock_t_in_worst_month | 51.2788 | 70.0000 | <= | выполнено | жёсткое |
...
| CAPACITY_EXCEEDED | 2037 | reserved_B_t_per_year | 3.5928 | 110.0000 | <= | выполнено | жёсткое |
| ORDER_EXCEEDS_RESERVATION | 2037 | ordered_B_t | 3.5928 | 3.5928 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2038 | end_of_month_stock_t_in_worst_month | 45.3702 | 120.0000 | <= | выполнено | жёсткое |
...
| INTRA_MONTH_PEAK | 2039 | intra_month_peak_stock_t_in_worst_month | 85.9616 | 120.0000 | <= | выполнено | жёсткое |
...
| INTRA_MONTH_PEAK | 2040 | intra_month_peak_stock_t_in_worst_month | 90.6983 | 120.0000 | <= | выполнено | жёсткое |
