...
|---|---|---:|
| Полные затраты, млн | `total_cost_mln` | 11,043.340 |
| Приведённые затраты (PV), млн | `pv_cost_mln` | 8,783.874 |
| Затраты на обслуженную тонну, млн/т | `cost_per_served_t_mln` | 7.945 |
| PV затрат на обслуженную тонну, млн/т | `pv_cost_per_served_t_mln` | 6.319 |
...
| Потери при хранении, т | `losses_total_t` | 37.526 |
| CAPEX, млн | `capex_total_mln` | 540.000 |
| Закупка, млн | `procurement_total_mln` | 9,755.249 |
| Резервирование мощности, млн | `reservation_total_mln` | 580.051 |
| Хранение, млн | `holding_total_mln` | 138.040 |
...
| 2037 | 190.0 | 135.0 | 190.0 | 1.000 | 1.000 | 0.0 | 211.2 | 9.50 | 23.4 | 35.1 | 23.4 | выполнен | BASE |
| 2038 | 250.0 | 170.0 | 250.0 | 1.000 | 1.000 | 0.0 | 261.8 | 7.46 | 35.1 | 39.5 | 30.8 | выполнен | ZBO |
...
| 2037 | 1343.1 | 0.0 | 90.7 | 20.2 | 0.0 | 180.0 | 1634.0 | 1400.9 |
| 2038 | 1687.6 | 0.0 | 107.0 | 26.1 | 6.0 | 0.0 | 1826.7 | 1450.1 |
...
| 2037 | Earth-Flex | 8.0 | 8.0 | 8.0 | 8.90 | 8.0 | 71.5 | 0.0 | 1.2 |
...
| RESERVE_45D | 2038 | opening_stock_vs_45d_reserve_t | 35.1413 | 30.8219 | >= | выполнено | жёсткое |
| RESERVE_45D | 2039 | opening_stock_vs_45d_reserve_t | 39.4523 | 39.4521 | >= | выполнено | жёсткое |
| RESERVE_45D | 2040 | opening_stock_vs_45d_reserve_t | 48.0824 | 48.0822 | >= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2037 | end_of_month_stock_t_in_worst_month | 35.1413 | 70.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2037 | intra_month_peak_stock_t_in_worst_month | 50.9747 | 70.0000 | <= | выполнено | жёсткое |
...
| CAPACITY_EXCEEDED | 2037 | reserved_B_t_per_year | 8.0332 | 110.0000 | <= | выполнено | жёсткое |
| ORDER_EXCEEDS_RESERVATION | 2037 | ordered_B_t | 8.0332 | 8.0332 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2038 | end_of_month_stock_t_in_worst_month | 35.1407 | 70.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2038 | intra_month_peak_stock_t_in_worst_month | 55.9740 | 70.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2039 | end_of_month_stock_t_in_worst_month | 48.0824 | 120.0000 | <= | выполнено | жёсткое |
