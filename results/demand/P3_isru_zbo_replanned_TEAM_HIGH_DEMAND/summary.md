...
| BASE_TOTAL_SERVICE | 2040 | total_service_level | 0.9745 | 0.9700 | >= | OK | guideline |
...
| CAPACITY_EXCEEDED | 2037 | reserved_B_t_per_year | 38.2660 | 110.0000 | <= | OK | hard |
| ORDER_EXCEEDS_RESERVATION | 2037 | ordered_B_t | 38.2659 | 38.2660 | <= | OK | hard |
...
| CAPACITY_EXCEEDED | 2038 | reserved_B_t_per_year | 37.2150 | 110.0000 | <= | OK | hard |
| ORDER_EXCEEDS_RESERVATION | 2038 | ordered_B_t | 37.2143 | 37.2150 | <= | OK | hard |
...
| CAPACITY_EXCEEDED | 2039 | reserved_B_t_per_year | 105.7770 | 110.0000 | <= | OK | hard |
| ORDER_EXCEEDS_RESERVATION | 2039 | ordered_B_t | 105.7770 | 105.7770 | <= | OK | hard |
...
| STORAGE_OVERFLOW | 2040 | max_end_of_month_stock_t | 54.0580 | 120.0000 | <= | OK | hard |
