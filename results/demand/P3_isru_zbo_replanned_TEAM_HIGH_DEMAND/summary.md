...
|---|---|---:|
| Полные затраты, млн | `total_cost_mln` | 12,577.438 |
| Приведённые затраты (PV), млн | `pv_cost_mln` | 10,142.872 |
...
| Хранение, млн | `holding_total_mln` | 133.727 |
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 2035 | 875.7 | 0.0 | 56.5 | 12.1 | 0.0 | 0.0 | 944.4 | 944.4 |
...
| INTRA_MONTH_PEAK | 2040 | intra_month_peak_stock_t_in_worst_month | 94.6830 | 120.0000 | <= | выполнено | жёсткое |
