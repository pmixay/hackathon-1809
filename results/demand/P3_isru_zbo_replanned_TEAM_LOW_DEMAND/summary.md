...
|---|---|---:|
| Полные затраты, млн | `total_cost_mln` | 8,392.867 |
| Приведённые затраты (PV), млн | `pv_cost_mln` | 6,872.892 |
| Затраты на обслуженную тонну, млн/т | `cost_per_served_t_mln` | 7.548 |
| PV затрат на обслуженную тонну, млн/т | `pv_cost_per_served_t_mln` | 6.181 |
...
| Закупка, млн | `procurement_total_mln` | 6,237.569 |
| Резервирование мощности, млн | `reservation_total_mln` | 370.702 |
| Хранение, млн | `holding_total_mln` | 102.596 |
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 2035 | 636.9 | 0.0 | 41.1 | 8.5 | 0.0 | 0.0 | 686.5 | 686.5 |
...
| 2040 | 1589.5 | 0.0 | 86.4 | 27.7 | 82.0 | 0.0 | 1785.6 | 1215.2 |
...
| 2040 | Earth-Flex | 5.8 | 5.8 | 5.8 | 8.90 | 5.8 | 51.5 | 0.0 | 0.9 |
...
| CAPACITY_EXCEEDED | 2040 | reserved_B_t_per_year | 5.7900 | 110.0000 | <= | выполнено | жёсткое |
| ORDER_EXCEEDS_RESERVATION | 2040 | ordered_B_t | 5.7895 | 5.7900 | <= | выполнено | жёсткое |
