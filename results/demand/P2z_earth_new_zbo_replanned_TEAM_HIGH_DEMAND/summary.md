...
| STORAGE_OVERFLOW | 2035 | max_end_of_month_stock_t | 18.9864 | 70.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2036 | max_end_of_month_stock_t | 25.7672 | 70.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2037 | max_end_of_month_stock_t | 38.5276 | 70.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2038 | max_end_of_month_stock_t | 49.3153 | 120.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2039 | max_end_of_month_stock_t | 60.1030 | 120.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2040 | max_end_of_month_stock_t | 54.8813 | 120.0000 | <= | выполнено | жёсткое |
