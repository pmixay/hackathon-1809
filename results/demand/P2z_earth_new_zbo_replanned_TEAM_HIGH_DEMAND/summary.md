...
|---|---|---:|
| Полные затраты, млн | `total_cost_mln` | 12,927.083 |
| Приведённые затраты (PV), млн | `pv_cost_mln` | 10,238.992 |
| Затраты на обслуженную тонну, млн/т | `cost_per_served_t_mln` | 7.739 |
| PV затрат на обслуженную тонну, млн/т | `pv_cost_per_served_t_mln` | 6.130 |
| Обслужено, т | `served_total_t` | 1,670.443 |
| Спрос, т | `demand_total_t` | 1,673.000 |
| Дефицит, т | `shortage_total_t` | 2.557 |
| Дефицит критического спроса, т | `shortage_critical_t` | 0.000 |
| Мин. уровень сервиса (общий) | `min_service_level_total` | 0.995 |
| Мин. уровень сервиса (критический) | `min_service_level_critical` | 1.000 |
| Потери при хранении, т | `losses_total_t` | 33.596 |
| CAPEX, млн | `capex_total_mln` | 540.000 |
| Закупка, млн | `procurement_total_mln` | 11,567.864 |
| Резервирование мощности, млн | `reservation_total_mln` | 634.708 |
| Хранение, млн | `holding_total_mln` | 142.511 |
...
| 2040 | 487.5 | 312.5 | 484.9 | 0.995 | 1.000 | 2.6 | 430.0 | 5.16 | 60.1 | 0.0 | 60.1 | выполнен | ZBO |
...
|---:|---:|---:|---:|---:|---:|---:|---:|---:|
| 2035 | 875.7 | 0.0 | 56.5 | 12.1 | 0.0 | 360.0 | 1304.4 | 1304.4 |
| 2036 | 1043.8 | 0.0 | 75.8 | 16.1 | 0.0 | 0.0 | 1135.7 | 1051.6 |
| 2037 | 1449.7 | 0.0 | 97.0 | 22.5 | 6.0 | 180.0 | 1755.1 | 1504.7 |
| 2038 | 2165.2 | 0.0 | 125.6 | 31.6 | 12.0 | 0.0 | 2334.4 | 1853.1 |
| 2039 | 2953.4 | 0.0 | 138.9 | 39.4 | 12.0 | 0.0 | 3143.7 | 2310.7 |
| 2040 | 3080.0 | 0.0 | 141.0 | 20.8 | 12.0 | 0.0 | 3253.8 | 2214.5 |
...
| 2037 | Earth-New | 38.3 | 38.3 | 38.3 | 7.10 | 38.3 | 271.7 | 0.0 | 11.5 |
| 2038 | Earth-Core | 190.0 | 190.0 | 190.0 | 6.20 | 190.0 | 1178.0 | 0.0 | 85.5 |
| 2038 | Earth-Flex | 7.2 | 7.2 | 7.2 | 8.90 | 7.2 | 64.2 | 0.0 | 1.1 |
| 2038 | Earth-New | 130.0 | 130.0 | 130.0 | 7.10 | 130.0 | 923.0 | 0.0 | 39.0 |
| 2039 | Earth-Core | 190.0 | 190.0 | 190.0 | 6.20 | 190.0 | 1178.0 | 0.0 | 85.5 |
| 2039 | Earth-Flex | 95.8 | 95.8 | 95.8 | 8.90 | 95.8 | 852.4 | 0.0 | 14.4 |
...
| BASE_TOTAL_SERVICE | 2040 | total_service_level | 0.9948 | 0.9700 | >= | выполнено | ориентир |
...
| INTRA_MONTH_PEAK | 2035 | intra_month_peak_stock_t_in_worst_month | 28.1531 | 70.0000 | <= | выполнено | жёсткое |
...
| INTRA_MONTH_PEAK | 2036 | intra_month_peak_stock_t_in_worst_month | 38.6006 | 70.0000 | <= | выполнено | жёсткое |
...
| INTRA_MONTH_PEAK | 2037 | intra_month_peak_stock_t_in_worst_month | 47.6809 | 70.0000 | <= | выполнено | жёсткое |
...
| CAPACITY_EXCEEDED | 2037 | reserved_C_t_per_year | 38.2660 | 130.0000 | <= | выполнено | жёсткое |
| ORDER_EXCEEDS_RESERVATION | 2037 | ordered_C_t | 38.2659 | 38.2660 | <= | выполнено | жёсткое |
...
| INTRA_MONTH_PEAK | 2038 | intra_month_peak_stock_t_in_worst_month | 75.3570 | 120.0000 | <= | выполнено | жёсткое |
...
| CAPACITY_EXCEEDED | 2038 | reserved_B_t_per_year | 7.2150 | 110.0000 | <= | выполнено | жёсткое |
| ORDER_EXCEEDS_RESERVATION | 2038 | ordered_B_t | 7.2143 | 7.2150 | <= | выполнено | жёсткое |
| CAPACITY_EXCEEDED | 2038 | reserved_C_t_per_year | 130.0000 | 130.0000 | <= | выполнено | жёсткое |
| ORDER_EXCEEDS_RESERVATION | 2038 | ordered_C_t | 130.0000 | 130.0000 | <= | выполнено | жёсткое |
...
| INTRA_MONTH_PEAK | 2039 | intra_month_peak_stock_t_in_worst_month | 93.4363 | 120.0000 | <= | выполнено | жёсткое |
...
| CAPACITY_EXCEEDED | 2039 | reserved_B_t_per_year | 95.7770 | 110.0000 | <= | выполнено | жёсткое |
| ORDER_EXCEEDS_RESERVATION | 2039 | ordered_B_t | 95.7770 | 95.7770 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2040 | end_of_month_stock_t_in_worst_month | 54.8813 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2040 | intra_month_peak_stock_t_in_worst_month | 95.5063 | 120.0000 | <= | выполнено | жёсткое |
