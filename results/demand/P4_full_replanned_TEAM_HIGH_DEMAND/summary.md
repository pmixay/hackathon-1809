...
|---|---|---:|
| Полные затраты, млн | `total_cost_mln` | 13,113.661 |
| Приведённые затраты (PV), млн | `pv_cost_mln` | 10,595.190 |
| Затраты на обслуженную тонну, млн/т | `cost_per_served_t_mln` | 7.838 |
| PV затрат на обслуженную тонну, млн/т | `pv_cost_per_served_t_mln` | 6.333 |
| Обслужено, т | `served_total_t` | 1,673.000 |
...
| Потери при хранении, т | `losses_total_t` | 34.357 |
| CAPEX, млн | `capex_total_mln` | 1,790.000 |
| Закупка, млн | `procurement_total_mln` | 10,336.927 |
| Резервирование мощности, млн | `reservation_total_mln` | 575.670 |
| Хранение, млн | `holding_total_mln` | 159.064 |
...
| 2040 | 487.5 | 312.5 | 487.5 | 1.000 | 1.000 | 0.0 | 493.4 | 5.92 | 60.1 | 60.1 | 60.1 | выполнен | ZBO |
...
| 2038 | 1742.2 | 0.0 | 96.7 | 25.7 | 82.0 | 0.0 | 1946.6 | 1545.3 |
| 2039 | 2289.0 | 0.0 | 117.2 | 39.4 | 82.0 | 0.0 | 2527.6 | 1857.9 |
| 2040 | 2936.4 | 0.0 | 132.5 | 43.3 | 82.0 | 0.0 | 3194.2 | 2173.9 |
...
| CAPACITY_EXCEEDED | 2038 | reserved_C_t_per_year | 37.2150 | 130.0000 | <= | выполнено | жёсткое |
| ORDER_EXCEEDS_RESERVATION | 2038 | ordered_C_t | 37.2143 | 37.2150 | <= | выполнено | жёсткое |
...
| CAPACITY_EXCEEDED | 2039 | reserved_C_t_per_year | 105.7770 | 130.0000 | <= | выполнено | жёсткое |
| ORDER_EXCEEDS_RESERVATION | 2039 | ordered_C_t | 105.7770 | 105.7770 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2040 | end_of_month_stock_t_in_worst_month | 60.1030 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2040 | intra_month_peak_stock_t_in_worst_month | 100.7280 | 120.0000 | <= | выполнено | жёсткое |
...
| CAPACITY_EXCEEDED | 2040 | reserved_B_t_per_year | 53.4220 | 110.0000 | <= | выполнено | жёсткое |
| ORDER_EXCEEDS_RESERVATION | 2040 | ordered_B_t | 53.4211 | 53.4220 | <= | выполнено | жёсткое |
