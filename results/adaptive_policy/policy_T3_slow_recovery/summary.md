# P3_isru_zbo_policy_T3_slow_recovery — TEAM_TRAJ_T3_SLOW_RECOVERY (T3 медленное восстановление ISRU)
...
|---|---|---:|
| Полные затраты, млн | `total_cost_mln` | 14,515.684 |
| Приведённые затраты (PV), млн | `pv_cost_mln` | 11,504.104 |
| Затраты на обслуженную тонну, млн/т | `cost_per_served_t_mln` | 9.468 |
| PV затрат на обслуженную тонну, млн/т | `pv_cost_per_served_t_mln` | 7.504 |
...
| Закупка, млн | `procurement_total_mln` | 12,112.722 |
| Резервирование мощности, млн | `reservation_total_mln` | 585.030 |
| Хранение, млн | `holding_total_mln` | 135.932 |
...
| 2039 | 3051.9 | 0.0 | 130.0 | 36.8 | 82.0 | 0.0 | 3300.7 | 2426.1 |
| 2040 | 3316.7 | 0.0 | 130.0 | 40.1 | 82.0 | 0.0 | 3568.7 | 2428.8 |
...
| 2039 | Earth-Flex | 110.0 | 104.6 | 104.6 | 11.12 | 104.6 | 1164.1 | 0.0 | 16.5 |
| 2039 | Lunar-ISRU | 120.0 | 120.0 | 78.0 | 3.00 | 120.0 | 360.0 | 0.0 | 0.0 |
| 2039 | Emergency | 80.0 | 4.0 | 4.0 | 13.80 | 4.0 | 55.3 | 0.0 | 28.0 |
| 2040 | Earth-Core | 190.0 | 190.0 | 190.0 | 6.20 | 190.0 | 1178.0 | 0.0 | 85.5 |
| 2040 | Earth-Flex | 110.0 | 110.0 | 110.0 | 8.90 | 110.0 | 979.0 | 0.0 | 16.5 |
| 2040 | Lunar-ISRU | 120.0 | 120.0 | 96.0 | 3.00 | 120.0 | 360.0 | 0.0 | 0.0 |
| 2040 | Emergency | 80.0 | 57.9 | 57.9 | 13.80 | 57.9 | 799.7 | 0.0 | 28.0 |
...
| RESERVE_45D | 2040 | opening_stock_vs_45d_reserve_t | 55.3027 | 55.2945 | >= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2039 | end_of_month_stock_t_in_worst_month | 55.3027 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2039 | intra_month_peak_stock_t_in_worst_month | 85.9693 | 120.0000 | <= | выполнено | жёсткое |
...
| ORDER_EXCEEDS_RESERVATION | 2039 | ordered_B_t | 104.6371 | 110.0000 | <= | выполнено | жёсткое |
...
| ORDER_EXCEEDS_RESERVATION | 2039 | ordered_E_t | 4.0096 | 80.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2040 | end_of_month_stock_t_in_worst_month | 58.2664 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2040 | intra_month_peak_stock_t_in_worst_month | 95.6414 | 120.0000 | <= | выполнено | жёсткое |
...
| ORDER_EXCEEDS_RESERVATION | 2040 | ordered_E_t | 57.9468 | 80.0000 | <= | выполнено | жёсткое |
