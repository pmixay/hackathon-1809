# P3_isru_zbo_policy_T4_fast_recovery — TEAM_TRAJ_T4_FAST_RECOVERY (T4 быстрое восстановление ISRU)
...
|---|---|---:|
| Полные затраты, млн | `total_cost_mln` | 13,845.507 |
| Приведённые затраты (PV), млн | `pv_cost_mln` | 11,029.542 |
| Затраты на обслуженную тонну, млн/т | `cost_per_served_t_mln` | 9.031 |
| PV затрат на обслуженную тонну, млн/т | `pv_cost_per_served_t_mln` | 7.194 |
...
| Закупка, млн | `procurement_total_mln` | 11,440.736 |
| Резервирование мощности, млн | `reservation_total_mln` | 585.030 |
| Хранение, млн | `holding_total_mln` | 137.741 |
...
| 2039 | 2711.1 | 0.0 | 130.0 | 38.7 | 82.0 | 0.0 | 2961.8 | 2177.0 |
| 2040 | 2985.5 | 0.0 | 130.0 | 40.0 | 82.0 | 0.0 | 3237.5 | 2203.4 |
...
| 2039 | Earth-Flex | 110.0 | 77.3 | 77.3 | 11.12 | 77.3 | 859.6 | 0.0 | 16.5 |
| 2039 | Lunar-ISRU | 120.0 | 120.0 | 108.0 | 3.00 | 120.0 | 360.0 | 0.0 | 0.0 |
...
| STORAGE_OVERFLOW | 2039 | end_of_month_stock_t_in_worst_month | 59.7996 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2039 | intra_month_peak_stock_t_in_worst_month | 90.4662 | 120.0000 | <= | выполнено | жёсткое |
...
| ORDER_EXCEEDS_RESERVATION | 2039 | ordered_B_t | 77.2712 | 110.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2040 | end_of_month_stock_t_in_worst_month | 57.2791 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2040 | intra_month_peak_stock_t_in_worst_month | 94.6541 | 120.0000 | <= | выполнено | жёсткое |
