# P3_isru_zbo_policy_T1_mandatory_stress — TEAM_TRAJ_T1_MANDATORY_STRESS (T1 обязательный стресс (сценарий организатора))
...
|---|---|---:|
| Полные затраты, млн | `total_cost_mln` | 14,044.847 |
| Приведённые затраты (PV), млн | `pv_cost_mln` | 11,176.042 |
| Затраты на обслуженную тонну, млн/т | `cost_per_served_t_mln` | 9.161 |
| PV затрат на обслуженную тонну, млн/т | `pv_cost_per_served_t_mln` | 7.290 |
...
| Закупка, млн | `procurement_total_mln` | 11,640.986 |
| Резервирование мощности, млн | `reservation_total_mln` | 585.030 |
| Хранение, млн | `holding_total_mln` | 136.831 |
...
| 2039 | 2911.4 | 0.0 | 130.0 | 37.4 | 82.0 | 0.0 | 3160.7 | 2323.2 |
| 2040 | 2985.5 | 0.0 | 130.0 | 40.4 | 82.0 | 0.0 | 3237.8 | 2203.6 |
...
| 2039 | Earth-Flex | 110.0 | 95.3 | 95.3 | 11.12 | 95.3 | 1059.9 | 0.0 | 16.5 |
| 2039 | Lunar-ISRU | 120.0 | 120.0 | 90.0 | 3.00 | 120.0 | 360.0 | 0.0 | 0.0 |
| 2039 | Emergency | 80.0 | 1.4 | 1.4 | 13.80 | 1.4 | 19.0 | 0.0 | 28.0 |
...
| 2040 | Emergency | 80.0 | 33.9 | 33.9 | 13.80 | 33.9 | 468.5 | 0.0 | 28.0 |
...
| RESERVE_45D | 2040 | opening_stock_vs_45d_reserve_t | 55.3034 | 55.2945 | >= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2039 | end_of_month_stock_t_in_worst_month | 55.3034 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2039 | intra_month_peak_stock_t_in_worst_month | 85.9700 | 120.0000 | <= | выполнено | жёсткое |
...
| ORDER_EXCEEDS_RESERVATION | 2039 | ordered_B_t | 95.2712 | 110.0000 | <= | выполнено | жёсткое |
...
| ORDER_EXCEEDS_RESERVATION | 2039 | ordered_E_t | 1.3762 | 80.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2040 | end_of_month_stock_t_in_worst_month | 60.2431 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2040 | intra_month_peak_stock_t_in_worst_month | 97.6181 | 120.0000 | <= | выполнено | жёсткое |
...
| ORDER_EXCEEDS_RESERVATION | 2040 | ordered_E_t | 33.9468 | 80.0000 | <= | выполнено | жёсткое |
