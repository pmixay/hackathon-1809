# P2z_guarded_calendar_3m — TEAM_EARTH_NEW_DELAY_00M (EXP-12: задержка Earth-New на копии данных)
...
|---|---|---:|
| Полные затраты, млн | `total_cost_mln` | 10,980.980 |
| Приведённые затраты (PV), млн | `pv_cost_mln` | 8,730.059 |
| Затраты на обслуженную тонну, млн/т | `cost_per_served_t_mln` | 7.900 |
| PV затрат на обслуженную тонну, млн/т | `pv_cost_per_served_t_mln` | 6.281 |
...
| Резервирование мощности, млн | `reservation_total_mln` | 580.165 |
...
| 2037 | 1271.6 | 0.0 | 90.8 | 17.8 | 6.0 | 180.0 | 1566.2 | 1342.8 |
...
| 2037 | Earth-New | 17.6 | 13.2 | 13.2 | 7.10 | 13.2 | 93.6 | 0.0 | 5.3 |
...
| ORDER_EXCEEDS_RESERVATION | 2037 | ordered_C_t | 13.1882 | 17.5850 | <= | выполнено | жёсткое |
