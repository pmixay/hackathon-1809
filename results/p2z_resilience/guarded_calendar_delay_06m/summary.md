# P2z_guarded_calendar_3m — TEAM_EARTH_NEW_DELAY_06M (EXP-12: задержка Earth-New на копии данных)
...
|---|---|---:|
| Полные затраты, млн | `total_cost_mln` | 10,967.385 |
| Приведённые затраты (PV), млн | `pv_cost_mln` | 8,719.499 |
| Затраты на обслуженную тонну, млн/т | `cost_per_served_t_mln` | 7.890 |
| PV затрат на обслуженную тонну, млн/т | `pv_cost_per_served_t_mln` | 6.273 |
...
| Потери при хранении, т | `losses_total_t` | 29.222 |
| CAPEX, млн | `capex_total_mln` | 540.000 |
| Закупка, млн | `procurement_total_mln` | 9,683.753 |
| Резервирование мощности, млн | `reservation_total_mln` | 577.527 |
| Хранение, млн | `holding_total_mln` | 124.104 |
...
| 2037 | 190.0 | 135.0 | 190.0 | 1.000 | 1.000 | 0.0 | 198.8 | 5.52 | 23.4 | 26.7 | 23.4 | выполнен | ZBO |
| 2038 | 250.0 | 170.0 | 250.0 | 1.000 | 1.000 | 0.0 | 261.8 | 3.14 | 26.7 | 35.3 | 30.8 | НЕ ВЫПОЛНЕН | ZBO |
| 2039 | 320.0 | 210.0 | 320.0 | 1.000 | 1.000 | 0.0 | 332.6 | 3.99 | 35.3 | 44.0 | 39.5 | НЕ ВЫПОЛНЕН | ZBO |
| 2040 | 390.0 | 250.0 | 390.0 | 1.000 | 1.000 | 0.0 | 394.7 | 4.74 | 44.0 | 44.0 | 48.1 | НЕ ВЫПОЛНЕН | ZBO |
...
| 2037 | 1271.6 | 0.0 | 88.1 | 15.9 | 6.0 | 180.0 | 1561.7 | 1338.9 |
| 2038 | 1687.6 | 0.0 | 107.0 | 22.3 | 12.0 | 0.0 | 1828.9 | 1451.9 |
| 2039 | 2213.3 | 0.0 | 126.4 | 28.5 | 12.0 | 0.0 | 2380.3 | 1749.6 |
| 2040 | 2766.2 | 0.0 | 135.7 | 31.6 | 12.0 | 0.0 | 2945.5 | 2004.7 |
...
| 2037 | Earth-New | 17.6 | 13.2 | 8.8 | 7.10 | 13.2 | 93.6 | 0.0 | 2.6 |
...
| RESERVE_45D | 2038 | opening_stock_vs_45d_reserve_t | 26.6965 | 30.8219 | >= | НАРУШЕНО | жёсткое |
| RESERVE_45D | 2039 | opening_stock_vs_45d_reserve_t | 35.3267 | 39.4521 | >= | НАРУШЕНО | жёсткое |
| RESERVE_45D | 2040 | opening_stock_vs_45d_reserve_t | 43.9568 | 48.0822 | >= | НАРУШЕНО | жёсткое |
...
| CAPACITY_EXCEEDED | 2037 | reserved_C_t_per_year | 17.5850 | 130.0000 | <= | выполнено | жёсткое |
| ORDER_EXCEEDS_RESERVATION | 2037 | ordered_C_t | 13.1882 | 8.7925 | <= | НАРУШЕНО | жёсткое |
...
| STORAGE_OVERFLOW | 2038 | end_of_month_stock_t_in_worst_month | 35.3267 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2038 | intra_month_peak_stock_t_in_worst_month | 56.1600 | 120.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2039 | end_of_month_stock_t_in_worst_month | 43.9568 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2039 | intra_month_peak_stock_t_in_worst_month | 70.6235 | 120.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2040 | end_of_month_stock_t_in_worst_month | 43.9569 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2040 | intra_month_peak_stock_t_in_worst_month | 76.4569 | 120.0000 | <= | выполнено | жёсткое |
...
|---|---|---:|---:|---|---:|---:|---:|---|
| SOURCE_NOT_AVAILABLE | жёсткое | 2037 | 4 | C | 1.465 | 0.000 | 1.465 | Earth-New: 1.465 т запланировано на 2037-04, раньше первой возможной поставки 2037-07 |
| SOURCE_NOT_AVAILABLE | жёсткое | 2037 | 5 | C | 1.465 | 0.000 | 1.465 | Earth-New: 1.465 т запланировано на 2037-05, раньше первой возможной поставки 2037-07 |
| SOURCE_NOT_AVAILABLE | жёсткое | 2037 | 6 | C | 1.465 | 0.000 | 1.465 | Earth-New: 1.465 т запланировано на 2037-06, раньше первой возможной поставки 2037-07 |
| ORDER_EXCEEDS_RESERVATION | жёсткое | 2037 |  | C | 13.188 | 8.793 | 4.396 | Earth-New 2037: заказано 13.188 т, что превышает контрактно доступный объём 8.793 т (резерв 17.6 т/год × 0.500 года) |
| RESERVE_45D | жёсткое | 2038 | 1 |  | 26.697 | 30.822 | 4.125 | 2038-01: физический запас 26.697 т < 45-дневного резерва 30.822 т |
| RESERVE_45D | жёсткое | 2039 | 1 |  | 35.327 | 39.452 | 4.125 | 2039-01: физический запас 35.327 т < 45-дневного резерва 39.452 т |
| RESERVE_45D | жёсткое | 2040 | 1 |  | 43.957 | 48.082 | 4.125 | 2040-01: физический запас 43.957 т < 45-дневного резерва 48.082 т |
