# P2z_stock_3.2t — TEAM_EARTH_NEW_DELAY_03M (EXP-12: задержка Earth-New на копии данных)
...
|---|---|---:|
| Полные затраты, млн | `total_cost_mln` | 11,008.142 |
| Приведённые затраты (PV), млн | `pv_cost_mln` | 8,753.352 |
| Затраты на обслуженную тонну, млн/т | `cost_per_served_t_mln` | 7.920 |
| PV затрат на обслуженную тонну, млн/т | `pv_cost_per_served_t_mln` | 6.297 |
...
| Потери при хранении, т | `losses_total_t` | 29.383 |
| CAPEX, млн | `capex_total_mln` | 540.000 |
| Закупка, млн | `procurement_total_mln` | 9,712.584 |
| Резервирование мощности, млн | `reservation_total_mln` | 578.829 |
| Хранение, млн | `holding_total_mln` | 134.730 |
...
| 2037 | 190.0 | 135.0 | 190.0 | 1.000 | 1.000 | 0.0 | 203.1 | 5.68 | 23.4 | 30.9 | 23.4 | выполнен | ZBO |
| 2038 | 250.0 | 170.0 | 250.0 | 1.000 | 1.000 | 0.0 | 261.8 | 3.14 | 30.9 | 39.5 | 30.8 | выполнен | ZBO |
...
| 2037 | 1300.5 | 0.0 | 89.4 | 17.5 | 6.0 | 180.0 | 1593.4 | 1366.1 |
| 2038 | 1687.6 | 0.0 | 107.0 | 25.3 | 12.0 | 0.0 | 1831.9 | 1454.3 |
| 2039 | 2213.3 | 0.0 | 126.4 | 31.5 | 12.0 | 0.0 | 2383.3 | 1751.8 |
| 2040 | 2766.2 | 0.0 | 135.7 | 34.7 | 12.0 | 0.0 | 2948.5 | 2006.7 |
...
| RESERVE_45D | 2038 | opening_stock_vs_45d_reserve_t | 30.8741 | 30.8219 | >= | выполнено | жёсткое |
| RESERVE_45D | 2039 | opening_stock_vs_45d_reserve_t | 39.5042 | 39.4521 | >= | выполнено | жёсткое |
| RESERVE_45D | 2040 | opening_stock_vs_45d_reserve_t | 48.1344 | 48.0822 | >= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2038 | end_of_month_stock_t_in_worst_month | 39.5042 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2038 | intra_month_peak_stock_t_in_worst_month | 60.3376 | 120.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2039 | end_of_month_stock_t_in_worst_month | 48.1344 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2039 | intra_month_peak_stock_t_in_worst_month | 74.8010 | 120.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2040 | end_of_month_stock_t_in_worst_month | 48.1344 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2040 | intra_month_peak_stock_t_in_worst_month | 80.6344 | 120.0000 | <= | выполнено | жёсткое |
