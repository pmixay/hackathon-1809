# P2z_stock_3.2t — TEAM_EARTH_NEW_DELAY_00M (EXP-12: задержка Earth-New на копии данных)
...
|---|---|---:|
| Полные затраты, млн | `total_cost_mln` | 11,017.916 |
| Приведённые затраты (PV), млн | `pv_cost_mln` | 8,760.910 |
| Затраты на обслуженную тонну, млн/т | `cost_per_served_t_mln` | 7.927 |
| PV затрат на обслуженную тонну, млн/т | `pv_cost_per_served_t_mln` | 6.303 |
...
| Потери при хранении, т | `losses_total_t` | 29.531 |
| CAPEX, млн | `capex_total_mln` | 540.000 |
| Закупка, млн | `procurement_total_mln` | 9,712.584 |
| Резервирование мощности, млн | `reservation_total_mln` | 579.818 |
| Хранение, млн | `holding_total_mln` | 143.514 |
...
| 2037 | 190.0 | 135.0 | 190.0 | 1.000 | 1.000 | 0.0 | 206.4 | 5.83 | 23.4 | 34.0 | 23.4 | выполнен | ZBO |
| 2038 | 250.0 | 170.0 | 250.0 | 1.000 | 1.000 | 0.0 | 261.8 | 3.14 | 34.0 | 42.7 | 30.8 | выполнен | ZBO |
| 2039 | 320.0 | 210.0 | 320.0 | 1.000 | 1.000 | 0.0 | 332.6 | 3.99 | 42.7 | 51.3 | 39.5 | выполнен | ZBO |
| 2040 | 390.0 | 250.0 | 390.0 | 1.000 | 1.000 | 0.0 | 394.7 | 4.74 | 51.3 | 51.3 | 48.1 | выполнен | ZBO |
...
| 2037 | 1300.5 | 0.0 | 90.4 | 19.5 | 6.0 | 180.0 | 1596.4 | 1368.7 |
| 2038 | 1687.6 | 0.0 | 107.0 | 27.6 | 12.0 | 0.0 | 1834.2 | 1456.1 |
| 2039 | 2213.3 | 0.0 | 126.4 | 33.8 | 12.0 | 0.0 | 2385.5 | 1753.4 |
| 2040 | 2766.2 | 0.0 | 135.7 | 36.9 | 12.0 | 0.0 | 2950.8 | 2008.3 |
...
| RESERVE_45D | 2038 | opening_stock_vs_45d_reserve_t | 34.0228 | 30.8219 | >= | выполнено | жёсткое |
| RESERVE_45D | 2039 | opening_stock_vs_45d_reserve_t | 42.6529 | 39.4521 | >= | выполнено | жёсткое |
| RESERVE_45D | 2040 | opening_stock_vs_45d_reserve_t | 51.2831 | 48.0822 | >= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2038 | end_of_month_stock_t_in_worst_month | 42.6529 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2038 | intra_month_peak_stock_t_in_worst_month | 63.4862 | 120.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2039 | end_of_month_stock_t_in_worst_month | 51.2831 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2039 | intra_month_peak_stock_t_in_worst_month | 77.9497 | 120.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2040 | end_of_month_stock_t_in_worst_month | 51.2831 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2040 | intra_month_peak_stock_t_in_worst_month | 83.7831 | 120.0000 | <= | выполнено | жёсткое |
