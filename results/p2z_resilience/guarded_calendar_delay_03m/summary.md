# P2z_guarded_calendar_3m — TEAM_EARTH_NEW_DELAY_03M (EXP-12: задержка Earth-New на копии данных)
...
|---|---|---:|
| Полные затраты, млн | `total_cost_mln` | 10,979.661 |
| Приведённые затраты (PV), млн | `pv_cost_mln` | 8,728.928 |
| Затраты на обслуженную тонну, млн/т | `cost_per_served_t_mln` | 7.899 |
| PV затрат на обслуженную тонну, млн/т | `pv_cost_per_served_t_mln` | 6.280 |
...
| Потери при хранении, т | `losses_total_t` | 29.420 |
...
| Хранение, млн | `holding_total_mln` | 135.061 |
...
| 2037 | 190.0 | 135.0 | 190.0 | 1.000 | 1.000 | 0.0 | 203.2 | 5.72 | 23.4 | 30.9 | 23.4 | выполнен | ZBO |
| 2038 | 250.0 | 170.0 | 250.0 | 1.000 | 1.000 | 0.0 | 261.8 | 3.14 | 30.9 | 39.5 | 30.8 | выполнен | ZBO |
| 2039 | 320.0 | 210.0 | 320.0 | 1.000 | 1.000 | 0.0 | 332.6 | 3.99 | 39.5 | 48.2 | 39.5 | выполнен | ZBO |
| 2040 | 390.0 | 250.0 | 390.0 | 1.000 | 1.000 | 0.0 | 394.7 | 4.74 | 48.2 | 48.2 | 48.1 | выполнен | ZBO |
...
| 2037 | 1271.6 | 0.0 | 89.5 | 17.8 | 6.0 | 180.0 | 1564.9 | 1341.6 |
| 2038 | 1687.6 | 0.0 | 107.0 | 25.4 | 12.0 | 0.0 | 1832.0 | 1454.3 |
| 2039 | 2213.3 | 0.0 | 126.4 | 31.6 | 12.0 | 0.0 | 2383.3 | 1751.8 |
...
| 2037 | Earth-New | 17.6 | 13.2 | 13.2 | 7.10 | 13.2 | 93.6 | 0.0 | 4.0 |
...
| RESERVE_45D | 2038 | opening_stock_vs_45d_reserve_t | 30.8948 | 30.8219 | >= | выполнено | жёсткое |
| RESERVE_45D | 2039 | opening_stock_vs_45d_reserve_t | 39.5249 | 39.4521 | >= | выполнено | жёсткое |
| RESERVE_45D | 2040 | opening_stock_vs_45d_reserve_t | 48.1551 | 48.0822 | >= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2037 | end_of_month_stock_t_in_worst_month | 23.3482 | 70.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2037 | intra_month_peak_stock_t_in_worst_month | 39.1815 | 70.0000 | <= | выполнено | жёсткое |
...
| ORDER_EXCEEDS_RESERVATION | 2037 | ordered_C_t | 13.1882 | 13.1888 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2038 | end_of_month_stock_t_in_worst_month | 39.5249 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2038 | intra_month_peak_stock_t_in_worst_month | 60.3583 | 120.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2039 | end_of_month_stock_t_in_worst_month | 48.1551 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2039 | intra_month_peak_stock_t_in_worst_month | 74.8217 | 120.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2040 | end_of_month_stock_t_in_worst_month | 48.1551 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2040 | intra_month_peak_stock_t_in_worst_month | 80.6551 | 120.0000 | <= | выполнено | жёсткое |
