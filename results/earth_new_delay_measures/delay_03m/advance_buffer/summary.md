...
|---|---|---:|
| Полные затраты, млн | `total_cost_mln` | 11,009.863 |
| Приведённые затраты (PV), млн | `pv_cost_mln` | 8,756.894 |
| Затраты на обслуженную тонну, млн/т | `cost_per_served_t_mln` | 7.921 |
| PV затрат на обслуженную тонну, млн/т | `pv_cost_per_served_t_mln` | 6.300 |
...
| Закупка, млн | `procurement_total_mln` | 9,713.106 |
| Резервирование мощности, млн | `reservation_total_mln` | 578.352 |
| Хранение, млн | `holding_total_mln` | 136.406 |
...
| 2036 | 140.0 | 105.0 | 140.0 | 1.000 | 1.000 | 0.0 | 156.3 | 7.04 | 17.3 | 26.6 | 17.3 | выполнен | BASE |
| 2037 | 190.0 | 135.0 | 190.0 | 1.000 | 1.000 | 0.0 | 199.9 | 5.64 | 26.6 | 30.8 | 23.4 | выполнен | ZBO |
...
| 2036 | 978.3 | 0.0 | 69.4 | 14.7 | 0.0 | 0.0 | 1062.4 | 983.7 |
| 2037 | 1271.6 | 0.0 | 88.5 | 19.2 | 6.0 | 180.0 | 1565.3 | 1342.0 |
...
| 2036 | Earth-Flex | 3.3 | 3.3 | 3.3 | 8.90 | 3.3 | 29.4 | 0.0 | 0.5 |
...
| RESERVE_45D | 2037 | opening_stock_vs_45d_reserve_t | 26.5745 | 23.4247 | >= | выполнено | жёсткое |
| RESERVE_45D | 2038 | opening_stock_vs_45d_reserve_t | 30.8232 | 30.8219 | >= | выполнено | жёсткое |
| RESERVE_45D | 2039 | opening_stock_vs_45d_reserve_t | 39.4533 | 39.4521 | >= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2036 | end_of_month_stock_t_in_worst_month | 26.5745 | 70.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2036 | intra_month_peak_stock_t_in_worst_month | 38.2412 | 70.0000 | <= | выполнено | жёсткое |
...
| CAPACITY_EXCEEDED | 2036 | reserved_B_t_per_year | 3.2980 | 110.0000 | <= | выполнено | жёсткое |
| ORDER_EXCEEDS_RESERVATION | 2036 | ordered_B_t | 3.2980 | 3.2980 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2037 | end_of_month_stock_t_in_worst_month | 25.8620 | 70.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2037 | intra_month_peak_stock_t_in_worst_month | 41.6953 | 70.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2038 | end_of_month_stock_t_in_worst_month | 39.4533 | 120.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2040 | end_of_month_stock_t_in_worst_month | 48.0835 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2040 | intra_month_peak_stock_t_in_worst_month | 80.5835 | 120.0000 | <= | выполнено | жёсткое |
