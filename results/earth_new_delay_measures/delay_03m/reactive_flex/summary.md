# P2z_delay03m_reactive_flex — TEAM_EXP12_DELAY_03M (Earth-New preparation delay 3 months; BASE demand/prices)
...
|---|---|---:|
| Полные затраты, млн | `total_cost_mln` | 11,007.120 |
| Приведённые затраты (PV), млн | `pv_cost_mln` | 8,752.436 |
...
| Хранение, млн | `holding_total_mln` | 134.423 |
...
| 2037 | 1300.2 | 88.9 | 17.7 | 6.0 | 180.0 | 1592.9 | 1365.6 |
...
| 2037 | Earth-Flex | 3.2 | 3.2 | 3.2 | 8.90 | 3.2 | 28.6 | 0.5 |
