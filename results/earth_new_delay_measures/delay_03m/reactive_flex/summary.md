# P2z_delay03m_reactive_flex — TEAM_EXP13_DELAY_03M (Earth-New preparation delay 3 months; BASE demand/prices)
...
|---|---|---:|
| Полные затраты, млн | `total_cost_mln` | 11,007.490 |
| Приведённые затраты (PV), млн | `pv_cost_mln` | 8,752.806 |
| Затраты на обслуженную тонну, млн/т | `cost_per_served_t_mln` | 7.919 |
...
| Потери при хранении, т | `losses_total_t` | 29.409 |
| CAPEX, млн | `capex_total_mln` | 540.000 |
| Закупка, млн | `procurement_total_mln` | 9,712.358 |
| Резервирование мощности, млн | `reservation_total_mln` | 578.339 |
| Хранение, млн | `holding_total_mln` | 134.793 |
...
| 2037 | 190.0 | 135.0 | 190.0 | 1.000 | 1.000 | 0.0 | 203.1 | 5.71 | 23.4 | 30.8 | 23.4 | выполнен | ZBO |
...
| 2037 | 1300.2 | 0.0 | 88.9 | 17.7 | 6.0 | 180.0 | 1592.9 | 1365.6 |
...
| 2037 | Earth-Flex | 3.2 | 3.2 | 3.2 | 8.90 | 3.2 | 28.6 | 0.0 | 0.5 |
...
| RESERVE_45D | 2038 | opening_stock_vs_45d_reserve_t | 30.8225 | 30.8219 | >= | выполнено | жёсткое |
| RESERVE_45D | 2039 | opening_stock_vs_45d_reserve_t | 39.4526 | 39.4521 | >= | выполнено | жёсткое |
| RESERVE_45D | 2040 | opening_stock_vs_45d_reserve_t | 48.0828 | 48.0822 | >= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2037 | end_of_month_stock_t_in_worst_month | 23.0659 | 70.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2037 | intra_month_peak_stock_t_in_worst_month | 38.8993 | 70.0000 | <= | выполнено | жёсткое |
...
| CAPACITY_EXCEEDED | 2037 | reserved_B_t_per_year | 3.2140 | 110.0000 | <= | выполнено | жёсткое |
| ORDER_EXCEEDS_RESERVATION | 2037 | ordered_B_t | 3.2140 | 3.2140 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2038 | end_of_month_stock_t_in_worst_month | 39.4526 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2038 | intra_month_peak_stock_t_in_worst_month | 60.2860 | 120.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2039 | end_of_month_stock_t_in_worst_month | 48.0828 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2039 | intra_month_peak_stock_t_in_worst_month | 74.7494 | 120.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2040 | end_of_month_stock_t_in_worst_month | 48.0828 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2040 | intra_month_peak_stock_t_in_worst_month | 80.5828 | 120.0000 | <= | выполнено | жёсткое |
