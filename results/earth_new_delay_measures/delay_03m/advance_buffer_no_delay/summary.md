# P2z_delay03m_advance_buffer — TEAM_EXP13_DELAY_00M (Earth-New preparation delay 0 months; BASE demand/prices)
...
|---|---|---:|
| Полные затраты, млн | `total_cost_mln` | 11,019.637 |
| Приведённые затраты (PV), млн | `pv_cost_mln` | 8,764.452 |
| Затраты на обслуженную тонну, млн/т | `cost_per_served_t_mln` | 7.928 |
| PV затрат на обслуженную тонну, млн/т | `pv_cost_per_served_t_mln` | 6.305 |
...
| Потери при хранении, т | `losses_total_t` | 29.641 |
| CAPEX, млн | `capex_total_mln` | 540.000 |
| Закупка, млн | `procurement_total_mln` | 9,713.106 |
| Резервирование мощности, млн | `reservation_total_mln` | 579.341 |
| Хранение, млн | `holding_total_mln` | 145.190 |
...
| 2037 | 190.0 | 135.0 | 190.0 | 1.000 | 1.000 | 0.0 | 203.2 | 5.79 | 26.6 | 34.0 | 23.4 | выполнен | ZBO |
| 2038 | 250.0 | 170.0 | 250.0 | 1.000 | 1.000 | 0.0 | 261.8 | 3.14 | 34.0 | 42.6 | 30.8 | выполнен | ZBO |
| 2039 | 320.0 | 210.0 | 320.0 | 1.000 | 1.000 | 0.0 | 332.6 | 3.99 | 42.6 | 51.2 | 39.5 | выполнен | ZBO |
| 2040 | 390.0 | 250.0 | 390.0 | 1.000 | 1.000 | 0.0 | 394.7 | 4.74 | 51.2 | 51.2 | 48.1 | выполнен | ZBO |
...
| 2037 | 1271.6 | 0.0 | 89.5 | 21.2 | 6.0 | 180.0 | 1568.3 | 1344.6 |
| 2038 | 1687.6 | 0.0 | 107.0 | 27.6 | 12.0 | 0.0 | 1834.2 | 1456.0 |
| 2039 | 2213.3 | 0.0 | 126.4 | 33.8 | 12.0 | 0.0 | 2385.5 | 1753.4 |
| 2040 | 2766.2 | 0.0 | 135.7 | 36.9 | 12.0 | 0.0 | 2950.8 | 2008.2 |
...
| RESERVE_45D | 2038 | opening_stock_vs_45d_reserve_t | 33.9718 | 30.8219 | >= | выполнено | жёсткое |
| RESERVE_45D | 2039 | opening_stock_vs_45d_reserve_t | 42.6020 | 39.4521 | >= | выполнено | жёсткое |
| RESERVE_45D | 2040 | opening_stock_vs_45d_reserve_t | 51.2321 | 48.0822 | >= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2037 | end_of_month_stock_t_in_worst_month | 28.5969 | 70.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2037 | intra_month_peak_stock_t_in_worst_month | 44.4302 | 70.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2038 | end_of_month_stock_t_in_worst_month | 42.6020 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2038 | intra_month_peak_stock_t_in_worst_month | 63.4353 | 120.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2039 | end_of_month_stock_t_in_worst_month | 51.2321 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2039 | intra_month_peak_stock_t_in_worst_month | 77.8988 | 120.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2040 | end_of_month_stock_t_in_worst_month | 51.2322 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2040 | intra_month_peak_stock_t_in_worst_month | 83.7322 | 120.0000 | <= | выполнено | жёсткое |
