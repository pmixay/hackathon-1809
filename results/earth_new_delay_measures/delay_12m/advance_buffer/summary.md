# P2z_delay12m_advance_buffer — TEAM_EXP12_DELAY_12M (Earth-New preparation delay 12 months; BASE demand/prices)
...
|---|---|---:|
| Полные затраты, млн | `total_cost_mln` | 11,102.749 |
| Приведённые затраты (PV), млн | `pv_cost_mln` | 8,842.776 |
...
| Хранение, млн | `holding_total_mln` | 140.691 |
...
| 2037 | 1271.6 | 85.5 | 23.6 | 6.0 | 180.0 | 1566.7 | 1343.2 |
