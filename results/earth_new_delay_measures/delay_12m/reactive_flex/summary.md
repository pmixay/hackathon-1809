...
|---|---|---:|
| Полные затраты, млн | `total_cost_mln` | 11,093.508 |
| Приведённые затраты (PV), млн | `pv_cost_mln` | 8,826.553 |
| Затраты на обслуженную тонну, млн/т | `cost_per_served_t_mln` | 7.981 |
| PV затрат на обслуженную тонну, млн/т | `pv_cost_per_served_t_mln` | 6.350 |
...
| Потери при хранении, т | `losses_total_t` | 29.381 |
| CAPEX, млн | `capex_total_mln` | 540.000 |
| Закупка, млн | `procurement_total_mln` | 9,800.148 |
| Резервирование мощности, млн | `reservation_total_mln` | 576.851 |
| Хранение, млн | `holding_total_mln` | 134.509 |
...
| 2037 | 190.0 | 135.0 | 190.0 | 1.000 | 1.000 | 0.0 | 203.1 | 5.68 | 23.4 | 30.8 | 23.4 | выполнен | ZBO |
...
| 2037 | 1388.0 | 0.0 | 87.5 | 17.4 | 6.0 | 180.0 | 1678.9 | 1439.4 |
...
| 2037 | Earth-Flex | 13.1 | 13.1 | 13.1 | 8.90 | 13.1 | 116.4 | 0.0 | 2.0 |
...
| CAPACITY_EXCEEDED | 2037 | reserved_B_t_per_year | 13.0780 | 110.0000 | <= | выполнено | жёсткое |
| ORDER_EXCEEDS_RESERVATION | 2037 | ordered_B_t | 13.0780 | 13.0780 | <= | выполнено | жёсткое |
...
| INTRA_MONTH_PEAK | 2039 | intra_month_peak_stock_t_in_worst_month | 74.7500 | 120.0000 | <= | выполнено | жёсткое |
