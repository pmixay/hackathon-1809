# P2z_delay06m_reactive_flex — TEAM_EXP12_DELAY_06M (Earth-New preparation delay 6 months; BASE demand/prices)
...
|---|---|---:|
| Полные затраты, млн | `total_cost_mln` | 11,034.552 |
| Приведённые затраты (PV), млн | `pv_cost_mln` | 8,775.955 |
...
| Хранение, млн | `holding_total_mln` | 133.758 |
...
| 2037 | 1328.8 | 88.4 | 17.0 | 6.0 | 180.0 | 1620.3 | 1389.2 |
...
| 2037 | Earth-Flex | 6.4 | 6.4 | 6.4 | 8.90 | 6.4 | 57.2 | 1.0 |
