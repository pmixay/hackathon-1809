# P2z_delay06m_reactive_flex — TEAM_EXP13_DELAY_06M (Earth-New preparation delay 6 months; BASE demand/prices)
...
|---|---|---:|
| Полные затраты, млн | `total_cost_mln` | 11,034.922 |
| Приведённые затраты (PV), млн | `pv_cost_mln` | 8,776.325 |
| Затраты на обслуженную тонну, млн/т | `cost_per_served_t_mln` | 7.939 |
| PV затрат на обслуженную тонну, млн/т | `pv_cost_per_served_t_mln` | 6.314 |
...
| Потери при хранении, т | `losses_total_t` | 29.326 |
| CAPEX, млн | `capex_total_mln` | 540.000 |
| Закупка, млн | `procurement_total_mln` | 9,740.963 |
| Резервирование мощности, млн | `reservation_total_mln` | 577.832 |
| Хранение, млн | `holding_total_mln` | 134.127 |
...
| 2037 | 190.0 | 135.0 | 190.0 | 1.000 | 1.000 | 0.0 | 203.0 | 5.62 | 23.4 | 30.8 | 23.4 | выполнен | ZBO |
...
| 2037 | 1328.8 | 0.0 | 88.4 | 17.0 | 6.0 | 180.0 | 1620.3 | 1389.2 |
...
| 2037 | Earth-Flex | 6.4 | 6.4 | 6.4 | 8.90 | 6.4 | 57.2 | 0.0 | 1.0 |
...
| RESERVE_45D | 2038 | opening_stock_vs_45d_reserve_t | 30.8227 | 30.8219 | >= | выполнено | жёсткое |
| RESERVE_45D | 2039 | opening_stock_vs_45d_reserve_t | 39.4529 | 39.4521 | >= | выполнено | жёсткое |
| RESERVE_45D | 2040 | opening_stock_vs_45d_reserve_t | 48.0830 | 48.0822 | >= | выполнено | жёсткое |
...
| CAPACITY_EXCEEDED | 2037 | reserved_B_t_per_year | 6.4280 | 110.0000 | <= | выполнено | жёсткое |
| ORDER_EXCEEDS_RESERVATION | 2037 | ordered_B_t | 6.4280 | 6.4280 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2038 | end_of_month_stock_t_in_worst_month | 39.4529 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2038 | intra_month_peak_stock_t_in_worst_month | 60.2862 | 120.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2039 | end_of_month_stock_t_in_worst_month | 48.0830 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2039 | intra_month_peak_stock_t_in_worst_month | 74.7497 | 120.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2040 | end_of_month_stock_t_in_worst_month | 48.0831 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2040 | intra_month_peak_stock_t_in_worst_month | 80.5831 | 120.0000 | <= | выполнено | жёсткое |
