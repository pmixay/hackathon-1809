# P2z_delay06m_advance_buffer — TEAM_EXP13_DELAY_06M (Earth-New preparation delay 6 months; BASE demand/prices)

План исполним: **НЕТ** — жёстких нарушений: 7, отклонений от ориентиров: 0, предупреждений: 0
...
|---|---|---:|
| Полные затраты, млн | `total_cost_mln` | 11,039.656 |
| Приведённые затраты (PV), млн | `pv_cost_mln` | 8,784.490 |
| Затраты на обслуженную тонну, млн/т | `cost_per_served_t_mln` | 7.942 |
| PV затрат на обслуженную тонну, млн/т | `pv_cost_per_served_t_mln` | 6.320 |
...
| Закупка, млн | `procurement_total_mln` | 9,742.449 |
| Резервирование мощности, млн | `reservation_total_mln` | 577.857 |
| Хранение, млн | `holding_total_mln` | 137.350 |
...
| 2036 | 140.0 | 105.0 | 140.0 | 1.000 | 1.000 | 0.0 | 159.6 | 7.18 | 17.3 | 29.7 | 17.3 | выполнен | BASE |
| 2037 | 190.0 | 135.0 | 190.0 | 1.000 | 1.000 | 0.0 | 196.6 | 5.49 | 29.7 | 30.8 | 23.4 | выполнен | ZBO |
...
| 2036 | 1007.6 | 0.0 | 69.9 | 14.8 | 0.0 | 0.0 | 1092.3 | 1011.4 |
| 2037 | 1271.6 | 0.0 | 87.5 | 20.1 | 6.0 | 180.0 | 1565.2 | 1341.9 |
...
| 2036 | Earth-Flex | 6.6 | 6.6 | 6.6 | 8.90 | 6.6 | 58.7 | 0.0 | 1.0 |
...
| RESERVE_45D | 2037 | opening_stock_vs_45d_reserve_t | 29.7231 | 23.4247 | >= | выполнено | жёсткое |
| RESERVE_45D | 2038 | opening_stock_vs_45d_reserve_t | 30.8231 | 30.8219 | >= | выполнено | жёсткое |
| RESERVE_45D | 2039 | opening_stock_vs_45d_reserve_t | 39.4532 | 39.4521 | >= | выполнено | жёсткое |
| RESERVE_45D | 2040 | opening_stock_vs_45d_reserve_t | 48.0834 | 48.0822 | >= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2036 | end_of_month_stock_t_in_worst_month | 29.7231 | 70.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2036 | intra_month_peak_stock_t_in_worst_month | 41.3898 | 70.0000 | <= | выполнено | жёсткое |
...
| CAPACITY_EXCEEDED | 2036 | reserved_B_t_per_year | 6.5950 | 110.0000 | <= | выполнено | жёсткое |
| ORDER_EXCEEDS_RESERVATION | 2036 | ordered_B_t | 6.5950 | 6.5950 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2037 | end_of_month_stock_t_in_worst_month | 29.0106 | 70.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2037 | intra_month_peak_stock_t_in_worst_month | 44.8440 | 70.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2038 | end_of_month_stock_t_in_worst_month | 39.4532 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2038 | intra_month_peak_stock_t_in_worst_month | 60.2866 | 120.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2039 | end_of_month_stock_t_in_worst_month | 48.0834 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2039 | intra_month_peak_stock_t_in_worst_month | 74.7501 | 120.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2040 | end_of_month_stock_t_in_worst_month | 48.0834 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2040 | intra_month_peak_stock_t_in_worst_month | 80.5834 | 120.0000 | <= | выполнено | жёсткое |
