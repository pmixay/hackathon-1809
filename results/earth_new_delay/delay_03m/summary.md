# P2z_earth_new_zbo_fixed_calendar — TEAM_EARTH_NEW_DELAY_03M (Earth-New preparation delay 3 months; BASE demand/prices)
...
|---|---|---:|
| Полные затраты, млн | `total_cost_mln` | 10,970.851 |
| Приведённые затраты (PV), млн | `pv_cost_mln` | 8,722.216 |
| Затраты на обслуженную тонну, млн/т | `cost_per_served_t_mln` | 7.893 |
| PV затрат на обслуженную тонну, млн/т | `pv_cost_per_served_t_mln` | 6.275 |
...
| Потери при хранении, т | `losses_total_t` | 29.344 |
...
| Хранение, млн | `holding_total_mln` | 127.240 |
...
| 2037 | 190.0 | 135.0 | 190.0 | 1.000 | 1.000 | 0.0 | 199.9 | 5.64 | 23.4 | 27.7 | 23.4 | выполнен | ZBO |
| 2038 | 250.0 | 170.0 | 250.0 | 1.000 | 1.000 | 0.0 | 261.8 | 3.14 | 27.7 | 36.3 | 30.8 | НЕ ВЫПОЛНЕН | ZBO |
| 2039 | 320.0 | 210.0 | 320.0 | 1.000 | 1.000 | 0.0 | 332.6 | 3.99 | 36.3 | 44.9 | 39.5 | НЕ ВЫПОЛНЕН | ZBO |
| 2040 | 390.0 | 250.0 | 390.0 | 1.000 | 1.000 | 0.0 | 394.7 | 4.74 | 44.9 | 44.9 | 48.1 | НЕ ВЫПОЛНЕН | ZBO |
...
| 2037 | 1271.6 | 0.0 | 88.5 | 16.9 | 6.0 | 180.0 | 1563.0 | 1340.1 |
| 2038 | 1687.6 | 0.0 | 107.0 | 23.0 | 12.0 | 0.0 | 1829.6 | 1452.4 |
| 2039 | 2213.3 | 0.0 | 126.4 | 29.2 | 12.0 | 0.0 | 2381.0 | 1750.1 |
| 2040 | 2766.2 | 0.0 | 135.7 | 32.4 | 12.0 | 0.0 | 2946.2 | 2005.1 |
...
|---|---:|---|---:|---|---|---:|---|
| Earth-New option (EARTH_NEW) | 90 | 2035-01 | 270 | 2035-01 | 2037-04 | 0 |  |
...
| 2037 | Earth-New | 13.2 | 13.2 | 9.9 | 7.10 | 13.2 | 93.6 | 0.0 | 3.0 |
...
| RESERVE_45D | 2038 | opening_stock_vs_45d_reserve_t | 27.6736 | 30.8219 | >= | НАРУШЕНО | жёсткое |
| RESERVE_45D | 2039 | opening_stock_vs_45d_reserve_t | 36.3037 | 39.4521 | >= | НАРУШЕНО | жёсткое |
| RESERVE_45D | 2040 | opening_stock_vs_45d_reserve_t | 44.9338 | 48.0822 | >= | НАРУШЕНО | жёсткое |
...
| ORDER_EXCEEDS_RESERVATION | 2037 | ordered_C_t | 13.1882 | 9.8918 | <= | НАРУШЕНО | жёсткое |
...
| STORAGE_OVERFLOW | 2038 | end_of_month_stock_t_in_worst_month | 36.3037 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2038 | intra_month_peak_stock_t_in_worst_month | 57.1370 | 120.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2039 | end_of_month_stock_t_in_worst_month | 44.9338 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2039 | intra_month_peak_stock_t_in_worst_month | 71.6005 | 120.0000 | <= | выполнено | жёсткое |
...
| STORAGE_OVERFLOW | 2040 | end_of_month_stock_t_in_worst_month | 44.9339 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2040 | intra_month_peak_stock_t_in_worst_month | 77.4339 | 120.0000 | <= | выполнено | жёсткое |
...
|---|---|---:|---:|---|---:|---:|---:|---|
| SOURCE_NOT_AVAILABLE | жёсткое | 2037 | 1 | C | 1.099 | 0.000 | 1.099 | Earth-New: 1.099 т запланировано на 2037-01, раньше первой возможной поставки 2037-04 |
| SOURCE_NOT_AVAILABLE | жёсткое | 2037 | 2 | C | 1.099 | 0.000 | 1.099 | Earth-New: 1.099 т запланировано на 2037-02, раньше первой возможной поставки 2037-04 |
| SOURCE_NOT_AVAILABLE | жёсткое | 2037 | 3 | C | 1.099 | 0.000 | 1.099 | Earth-New: 1.099 т запланировано на 2037-03, раньше первой возможной поставки 2037-04 |
| ORDER_EXCEEDS_RESERVATION | жёсткое | 2037 |  | C | 13.188 | 9.892 | 3.296 | Earth-New 2037: заказано 13.188 т, что превышает контрактно доступный объём 9.892 т (резерв 13.2 т/год × 0.750 года) |
| RESERVE_45D | жёсткое | 2038 | 1 |  | 27.674 | 30.822 | 3.148 | 2038-01: физический запас 27.674 т < 45-дневного резерва 30.822 т |
| RESERVE_45D | жёсткое | 2039 | 1 |  | 36.304 | 39.452 | 3.148 | 2039-01: физический запас 36.304 т < 45-дневного резерва 39.452 т |
| RESERVE_45D | жёсткое | 2040 | 1 |  | 44.934 | 48.082 | 3.148 | 2040-01: физический запас 44.934 т < 45-дневного резерва 48.082 т |
