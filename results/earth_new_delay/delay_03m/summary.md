...
Feasible: **NO** — hard violations: 7, guideline: 0, warnings: 0

| KPI | Value |
|---|---:|
| total_cost_mln | 10,970.481 |
| pv_cost_mln | 8,721.846 |
| cost_per_served_t_mln | 7.892 |
| pv_cost_per_served_t_mln | 6.275 |
...
| losses_total_t | 29.344 |
| capex_total_mln | 540.000 |
| procurement_total_mln | 9,683.753 |
| reservation_total_mln | 577.857 |
| holding_total_mln | 126.870 |
...
| 2037 | 190.0 | 135.0 | 190.0 | 1.000 | 1.000 | 0.0 | 199.9 | 5.64 | 23.4 | 27.7 | 23.4 | yes | ZBO |
| 2038 | 250.0 | 170.0 | 250.0 | 1.000 | 1.000 | 0.0 | 261.8 | 3.14 | 27.7 | 36.3 | 30.8 | NO | ZBO |
| 2039 | 320.0 | 210.0 | 320.0 | 1.000 | 1.000 | 0.0 | 332.6 | 3.99 | 36.3 | 44.9 | 39.5 | NO | ZBO |
| 2040 | 390.0 | 250.0 | 390.0 | 1.000 | 1.000 | 0.0 | 394.7 | 4.74 | 44.9 | 44.9 | 48.1 | NO | ZBO |
...
| RESERVE_45D | 2038 | opening_stock_vs_45d_reserve_t | 27.6736 | 30.8219 | >= | VIOLATED | hard |
| RESERVE_45D | 2039 | opening_stock_vs_45d_reserve_t | 36.3037 | 39.4521 | >= | VIOLATED | hard |
| RESERVE_45D | 2040 | opening_stock_vs_45d_reserve_t | 44.9338 | 48.0822 | >= | VIOLATED | hard |
...
| STORAGE_OVERFLOW | 2037 | max_end_of_month_stock_t | 27.6736 | 70.0000 | <= | OK | hard |
...
| ORDER_EXCEEDS_RESERVATION | 2037 | ordered_C_t | 13.1882 | 9.8918 | <= | VIOLATED | hard |
...
| STORAGE_OVERFLOW | 2038 | max_end_of_month_stock_t | 36.3037 | 120.0000 | <= | OK | hard |
...
| STORAGE_OVERFLOW | 2039 | max_end_of_month_stock_t | 44.9338 | 120.0000 | <= | OK | hard |
...
| STORAGE_OVERFLOW | 2040 | max_end_of_month_stock_t | 44.9339 | 120.0000 | <= | OK | hard |
...
|---|---|---:|---:|---|---:|---:|---:|---|
| SOURCE_NOT_AVAILABLE | hard | 2037 | 1 | C | 1.099 | 0.000 | 1.099 | Earth-New: 1.099 t scheduled for 2037-01 before first possible delivery 2037-04 |
| SOURCE_NOT_AVAILABLE | hard | 2037 | 2 | C | 1.099 | 0.000 | 1.099 | Earth-New: 1.099 t scheduled for 2037-02 before first possible delivery 2037-04 |
| SOURCE_NOT_AVAILABLE | hard | 2037 | 3 | C | 1.099 | 0.000 | 1.099 | Earth-New: 1.099 t scheduled for 2037-03 before first possible delivery 2037-04 |
| ORDER_EXCEEDS_RESERVATION | hard | 2037 |  | C | 13.188 | 9.892 | 3.296 | Earth-New 2037: ordered 13.188 t exceeds contractually available 9.892 t (reserved 13.2 t/yr x 0.750 of year) |
| RESERVE_45D | hard | 2038 | 1 |  | 27.674 | 30.822 | 3.148 | 2038-01: physical stock 27.674 t < 45-day reserve 30.822 t |
| RESERVE_45D | hard | 2039 | 1 |  | 36.304 | 39.452 | 3.148 | 2039-01: physical stock 36.304 t < 45-day reserve 39.452 t |
| RESERVE_45D | hard | 2040 | 1 |  | 44.934 | 48.082 | 3.148 | 2040-01: physical stock 44.934 t < 45-day reserve 48.082 t |
