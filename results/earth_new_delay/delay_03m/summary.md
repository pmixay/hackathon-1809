...
|---|---|---:|
| Полные затраты, млн | `total_cost_mln` | 10,970.481 |
| Приведённые затраты (PV), млн | `pv_cost_mln` | 8,721.846 |
| Затраты на обслуженную тонну, млн/т | `cost_per_served_t_mln` | 7.892 |
...
| Хранение, млн | `holding_total_mln` | 126.870 |
