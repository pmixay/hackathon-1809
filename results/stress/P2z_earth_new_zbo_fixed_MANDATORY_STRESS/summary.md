...
|---|---|---:|
| Полные затраты, млн | `total_cost_mln` | 11,518.134 |
| Приведённые затраты (PV), млн | `pv_cost_mln` | 9,143.268 |
...
| Хранение, млн | `holding_total_mln` | 56.452 |
...
| INTRA_MONTH_PEAK | 2038 | intra_month_peak_stock_t_in_worst_month | 52.3748 | 120.0000 | <= | выполнено | жёсткое |
...
| INTRA_MONTH_PEAK | 2039 | intra_month_peak_stock_t_in_worst_month | 29.3382 | 120.0000 | <= | выполнено | жёсткое |
