...
|---|---|---:|
| Полные затраты, млн | `total_cost_mln` | 13,112.752 |
| Приведённые затраты (PV), млн | `pv_cost_mln` | 10,578.598 |
| Затраты на обслуженную тонну, млн/т | `cost_per_served_t_mln` | 8.548 |
| PV затрат на обслуженную тонну, млн/т | `pv_cost_per_served_t_mln` | 6.896 |
...
| Потери при хранении, т | `losses_total_t` | 31.408 |
| CAPEX, млн | `capex_total_mln` | 1,790.000 |
| Закупка, млн | `procurement_total_mln` | 10,366.326 |
| Резервирование мощности, млн | `reservation_total_mln` | 556.297 |
| Хранение, млн | `holding_total_mln` | 148.130 |
...
| 2038 | 2170.4 | 0.0 | 102.3 | 25.8 | 82.0 | 0.0 | 2380.5 | 1889.7 |
| 2039 | 2560.4 | 0.0 | 116.3 | 36.2 | 82.0 | 0.0 | 2794.8 | 2054.3 |
| 2040 | 2585.1 | 0.0 | 126.6 | 39.8 | 82.0 | 0.0 | 2833.5 | 1928.5 |
...
| STORAGE_OVERFLOW | 2040 | end_of_month_stock_t_in_worst_month | 55.2950 | 120.0000 | <= | выполнено | жёсткое |
| INTRA_MONTH_PEAK | 2040 | intra_month_peak_stock_t_in_worst_month | 92.6700 | 120.0000 | <= | выполнено | жёсткое |
