...
def main() -> None:
    ...
    lines = [
        ...
        "",
        "До взвешивания действует фильтр допуска: архитектура должна проходить жёсткие ограничения BASE и иметь заблаговременно адаптированный план MANDATORY_STRESS без жёстких нарушений. В стрессе пороги сервиса 97%/99% имеют статус guideline, а не hard; R2 дополнительно требует 100% общего и критического сервиса как некомпенсируемое правило отбора. Поэтому P1/P2 не оцениваются; P2z, P3 и P4 проходят фильтр.",
        "",
        "## Метрики решения",
        "",
